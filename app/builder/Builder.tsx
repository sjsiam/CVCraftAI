...
import { FileText, Download, Loader2, ArrowLeft, Mail, Copy } from 'lucide-react';
...
const CVTemplate = ({ content, title }: { content: string; title: string }) => (
  <div id={`cv-${title.toLowerCase()}`} className="bg-white min-h-[800px] shadow-lg rounded-lg overflow-hidden">
    <div 
...
const CoverLetterTemplate = ({ content }: { content: string }) => (
  <div id="cover-letter" className="bg-white min-h-[600px] shadow-lg rounded-lg overflow-hidden p-8">
    <div 
...
export default function Builder() {
  ...
  const loadingMessages = [
    'Discussing with the AI...',
    'AI is creating...',
    'AI submitted the data...',
    'AI made so many mistakes...',
    'Scolding AI for his mistakes...',
    'AI doing everything again while crying...',
    'AI submitted his best...',
    'Showing the best to you...'
  ];
  ...
  const loadSampleData = () => {
    form.reset({
      ...
      summary: 'Experienced software engineer with 6+ years of expertise in full-stack development, cloud architecture, and team leadership. Passionate about building scalable solutions and mentoring junior developers.',
      education: 'Bachelor of Science in Computer Science, University of California Berkeley, 2017-2021',
      experience: 'Senior Software Engineer at TechCorp (2022-Present): Led development of microservices architecture serving 1M+ users, implemented CI/CD pipelines reducing deployment time by 60%, mentored 5 junior developers. Software Engineer at StartupXYZ (2021-2022): Built responsive web applications using React and Node.js, collaborated with cross-functional teams, improved application performance by 40%.',
      skills: 'JavaScript, TypeScript, React, Node.js, Python, AWS, Docker, Kubernetes, PostgreSQL, MongoDB, Git, Agile/Scrum',
      languages: 'English (Native), Spanish (Conversational), Mandarin (Basic)',
      achievements: 'Led team that won internal hackathon for AI-powered analytics tool, Increased code coverage from 45% to 85% across multiple repositories, Published 3 technical articles with 10K+ views, Certified AWS Solutions Architect',
    ...
    coverLetterForm.reset({
      ...
      jobCircular: 'We are looking for a Senior Full Stack Developer to join our team. The ideal candidate should have experience with React, Node.js, and cloud technologies. You will be responsible for building scalable web applications and mentoring junior developers.',
    });
  };
  ...
  const downloadPDF = async (templateName: string, type: 'cv' | 'cover-letter' = 'cv') => {
    const elementId = type === 'cv' ? `cv-${templateName.toLowerCase()}` : 'cover-letter';
    ...
    if (element) {
      try {
        ...
        const fileName = type === 'cv' ? `cv-${templateName.toLowerCase()}.pdf` : 'cover-letter.pdf';
        pdf.save(fileName);
      } catch (error) {
          ...
          <div className="space-y-6">
            ...
            <Card className="shadow-lg border-0">
              <CardHeader className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
                ...
                <p className="text-blue-100">Fill in your details to generate a professional CV</p>
              </CardHeader>
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div>
                    ...
                    {form.formState.errors.targetRole && (
                      <p className="text-red-500 text-sm mt-1">{form.formState.errors.targetRole.message}</p>
                    )}
                  </div>
                </form>
              </CardContent>
            ...
            <Card className="shadow-lg border-0">
              <CardHeader className="bg-gradient-to-r from-purple-600 to-pink-600 text-white">
                ...
                <p className="text-purple-100">Optional: Add company details for a personalized cover letter</p>
              </CardHeader>
              <CardContent className="p-6">
                <div className="space-y-4">
                  ...
                  <div>
                    <Label htmlFor="jobCircular">Job Description/Circular</Label>
                    <Textarea
                      id="jobCircular"
            ...
            {generatedContent ? (
              <Card className="shadow-lg border-0">
                <CardHeader className="bg-gradient-to-r from-green-600 to-teal-600 text-white">
                  <CardTitle className="text-2xl">Your Generated Content</CardTitle>
                  <p className="text-green-100">Choose your preferred template and download as PDF</p>
                </CardHeader>
                <CardContent className="p-6">
                  <Tabs value={activeTab} onValueChange={setActiveTab}>
                    ...
                    <div className="mt-4">
                      <TabsContent value="professional">
                        <div className="space-y-4">
                          <div className="flex justify-between items-center">
                            <h3 className="text-lg font-semibold">Professional Template</h3>
                            <Button
                          ...
                          <CVTemplate content={generatedContent.professional} title="professional" />
                        </div>
                      </TabsContent>
                      ...
                      <TabsContent value="concise">
                        <div className="space-y-4">
                          <div className="flex justify-between items-center">
                            <h3 className="text-lg font-semibold">Concise Template</h3>
                            <Button
                          ...
                          <CVTemplate content={generatedContent.concise} title="concise" />
                        </div>
                      </TabsContent>
                      ...
                      <TabsContent value="creative">
                        <div className="space-y-4">
                          <div className="flex justify-between items-center">
                            <h3 className="text-lg font-semibold">Creative Template</h3>
                            <Button
                          ...
                          <CVTemplate content={generatedContent.creative} title="creative" />
                        </div>
                      </TabsContent>
                      ...
                      <TabsContent value="cover-letter">
                        <div className="space-y-4">
                          <div className="flex justify-between items-center">
                            ...
                            <Button
                              onClick={() => downloadPDF('cover-letter', 'cover-letter')}
              ...
              <Card className="shadow-lg border-0">
                <CardContent className="p-12 text-center">
                  ...
                  <h3 className="text-xl font-semibold text-gray-600 mb-2">Content Preview</h3>
                  <p className="text-gray-500">
                    Fill out the forms and click &quot;Generate My CV & Cover Letter&quot; to see your professional content here.
                  </p>
                </CardContent>
              </Card>
            )}
